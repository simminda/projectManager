	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (input == 1) {
				...
				details.nextLine();
				System.out.println("Enter project Name (e.g. Tom's House): ");
				...
				if (edit == 1) {
					...
					// Future update - last invoice number can be read from a file and then incremented
					Invoice invoice = new Invoice(001, date, con, 1000000.00);
					System.out.println("\nThank you.\n"); 
			    ...
			    if (choice == 'e') {
			   	...
			   	// if user enters any number on main menu either than those assigned to a function
